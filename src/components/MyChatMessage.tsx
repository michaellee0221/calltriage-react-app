...
const MyChatMessage: React.FC<MyChatMessageProps> = ({
  ...
  return (
    <div className="flex items-start justify-end gap-2.5 group">
      <div className="flex flex-col w-fit max-w-[80%] sm:max-w-[75%] md:max-w-[70%] lg:max-w-[60%] items-end">
        ...
        <div className="flex items-center space-x-2 rtl:space-x-reverse">
          ...
          >
            ...
            {/* Dropdown menu */}
            {isMenuOpen && (
              <div className="absolute z-10 mt-9 right-0 bg-gray-50 bg-opacity-90 divide-y divide-gray-100 rounded-lg shadow-sm md:w-40">
          ...
          {type === "0" && (
            <div className="flex flex-col leading-1.5 p-3 bg-gray-100 rounded-s-xl rounded-ee-xl">
              <p className="text-sm font-normal text-red-700 break-all whitespace-pre-wrap">
                {message}
              </p>
            </div>
          )}
